...
public class HelpersFactoryGenerator extends Generator<HttpActionClass> {
    ...
    public void generate(ArrayList<HttpActionClass> actionClasses) {
        TypeSpec.Builder classBuilder = TypeSpec.classBuilder(HttpActionAdapter.HELPERS_FACTORY_CLASS_SIMPLE_NAME)
                .addModifiers(Modifier.PUBLIC, Modifier.FINAL)
                .addJavadoc("Autogenerated class factory for instationa action helpers")
                .addSuperinterface(ParameterizedTypeName.get(HttpActionAdapter.ActionHelperFactory.class));

        MethodSpec.Builder makeMethodBuilder = MethodSpec.methodBuilder("make")
                .addModifiers(Modifier.PUBLIC)
                .addAnnotation(Override.class)
                .returns(HttpActionAdapter.ActionHelper.class)
        ...
        saveClass(HttpActionAdapter.class.getPackage().getName(), classBuilder.build());
    }
}
